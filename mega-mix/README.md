...
```bash
mega-mix$ sam logs -n StockCheckerFunction --stack-name mega-mix --tail
```
...
```bash
mega-mix$ cd functions/stock-checker
...
```bash
aws cloudformation delete-stack --stack-name mega-mix
```
